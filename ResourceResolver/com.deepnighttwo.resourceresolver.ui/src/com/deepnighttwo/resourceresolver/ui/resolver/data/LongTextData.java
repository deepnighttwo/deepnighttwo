...
public class LongTextData implements IResourceDetailsData {

	private static Image image = Activator.getImageDescriptor(
			"icons/more_details.gif").createImage();

	private String content;

	public LongTextData(String content) {
		if (content == null) {
			content = "";
		}
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		LongTextData other = (LongTextData) obj;
		if (content == null) {
