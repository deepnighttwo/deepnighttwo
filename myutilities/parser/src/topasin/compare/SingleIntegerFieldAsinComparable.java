 ...
 * 
 */
public final class SingleIntegerFieldAsinComparable implements AsinComparable {
    ...
    public int compareForTopAsin(AsinComparable asin) {
        return compareAbsDiff((SingleIntegerFieldAsinComparable) asin);
    }

    @Override
    public int compareForOutputSort(AsinComparable asin) {
        return -1 * compareAbsDiff((SingleIntegerFieldAsinComparable) asin);
    }

    private int compareAbsDiff(SingleIntegerFieldAsinComparable asin) {
        if (asin == null) {
            return 1;
        }
