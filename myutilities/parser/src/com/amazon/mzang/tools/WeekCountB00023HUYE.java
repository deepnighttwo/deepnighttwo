...
public class WeekCountB00023HUYE {

    private static double hc = 0.06653 + 0.01663;
    private static double revnew = 13.140000 - 8.6714286;
    ...
    private static void normal() throws IOException {
        List<String> lines = FileUtil.readFileAsLines("weekforecastB00023HUYE.txt");
    ...
    private static void markdown() throws IOException {
        ...
        double hc = 0.06653 + 0.01663;
        double mkdiii = 1 + 1.4466990;
        double tm = 0;
        log("Week,Forecast,Total Inventory,Markdown Inventory,Money Got This Week,Money Got Per Item\r\n");
        for (int i = 0; i <= 51; i++) {
            double rrr = 0;
            if (total < 0) {
                break;
